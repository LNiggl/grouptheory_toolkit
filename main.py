...
# TP_Rep1.check_if_homomorphism2()
...
# TP_Rep2.check_if_homomorphism2()
...
# TP_Rep3.check_if_homomorphism2()
...
# TP_Rep4.check_if_homomorphism2()
...
# pvec1 = o.PseudoVectorField([2,1,0])
# pvec2 = o.PseudoVectorField([-2,-1,0])
# ten_pvec = o.TensorProduct(pvec1,pvec2)
# b_pvec = o.generate_basis(ten_pvec,O_h)
# t_pvec_rep = r.rep_from_action(O_h,b_pvec,"2pseudovector_rep")
# o.print_all(t_pvec_rep.basis)
# t_pvec_rep.check_if_homomorphism()
# r.study_irreps(t_pvec_rep,O_h,"../results/PseudoVectorParticle_irreps.txt")

psca1 = o.PseudoScalarField([2,1,0])
psca2 = o.PseudoScalarField([-2,-1,0])
t_psca = o.TensorProduct(psca1,psca2)
b_tpsca = o.generate_basis(t_psca,O_h)
tpsca_rep = r.rep_from_action(O_h,b_tpsca,"2pseudoscalar_rep")
o.print_all(tpsca_rep.basis)
print("action direction: ", t_psca.direction_action)
tpsca_rep.check_if_homomorphism()
r.study_irreps(tpsca_rep,O_h,"../results/TwoPseudoScalarParticle210_irreps.txt")
