...
print(O_h.char_table)

#(2,1,0) - type 2Pion    

p1 = o.PseudoScalarField([2,1,0],explicit_momentum_trafo=False)
p2 = o.PseudoScalarField([-2,-1,0],explicit_momentum_trafo=False)
...
## tests ##
f = open("../tests/twopi210_test_trafos_right_action.txt","w")
...
##
subspaces = r.study_irreps(pi210,O_h,"../results/test_twopi210_irreps_right_action.txt",1)
#test for full T2_identify_components function
# c.nice_string("../tests/test_T2m1.txt")
# c.nice_string("../tests/test_T2m2.txt")
# c.compare_strings("../tests/test_T2m1_nice.txt","../tests/test_T2m2_nice.txt")
#test for projector in T2_identify_components
# c.compare_strings("../tests/test_pi210_P_1.txt","../tests/test_pi210_P_2.txt")
##
...
# master_filepath = "D:/Master/Masterarbeit/results/files_operators_gpt/"
