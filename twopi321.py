...
name = "twopi321"
p1 = o.PseudoScalarField([3,2,1],modified_momentum_trafo=True)
p2 = o.PseudoScalarField([-3,-2,-1],modified_momentum_trafo=True)
...
pi321 = r.rep_from_action(O_h,b1,"twopi321")
...
subspaces = r.study_irreps(pi321,O_h,filepath + "summary_irreps/" + name + ".txt")
