...
testLC = o.LinearCombination(pi210.basis,weights_pi210[0])
testLC.printname()
testLC.action("Rot0")
testLC.printname()
...
all_disjoint = t.subspaces_disjoint(subspaces_reordered,pi210)
print("all subspaces disjoint: " , all_disjoint)
