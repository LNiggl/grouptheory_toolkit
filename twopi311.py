...
p2 = o.PseudoScalarField([-3,-1,-1],modified_momentum_trafo=True)
...
pi311 = r.rep_from_action(O_h,b1,"twopi311")
...
subspaces = r.study_irreps(pi311,O_h,filepath + "summary_irreps/" + name + ".txt")
