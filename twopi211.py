...
name = "twopi211"
p1 = o.PseudoScalarField([2,1,1],modified_momentum_trafo=True)
p2 = o.PseudoScalarField([-2,-1,-1],modified_momentum_trafo=True)
...
pi211 = r.rep_from_action(O_h,b1,"twopi211")
...
subspaces = r.study_irreps(pi211,O_h,filepath + "summary_irreps/" + name + ".txt")
