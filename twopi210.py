...
name = "twopi210"
p1 = o.PseudoScalarField([2,1,0],modified_momentum_trafo=True)
p2 = o.PseudoScalarField([-2,-1,0],modified_momentum_trafo=True)
...
pi210 = r.rep_from_action(O_h,b1,"twopi210")
...
##
subspaces = r.study_irreps(pi210,O_h,filepath + "summary_irreps/" + name + ".txt")
...
# import sys
# sys.exit()
# print(subspaces_ordered_by_space)
