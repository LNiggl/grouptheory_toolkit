...
name = "twopi310"
p1 = o.PseudoScalarField([3,1,0],modified_momentum_trafo=True)
p2 = o.PseudoScalarField([-3,-1,0],modified_momentum_trafo=True)
...
pi310 = r.rep_from_action(O_h,b1,"twopi310")
...
subspaces = r.study_irreps(pi310,O_h,filepath + "summary_irreps/" + name + ".txt")
