...
name = "twopi111"
p1 = o.PseudoScalarField([1,1,1],modified_momentum_trafo=True)
p2 = o.PseudoScalarField([-1,-1,-1],modified_momentum_trafo=True)
...
pi111 = r.rep_from_action(O_h,b1,"twopi111")
...
subspaces = r.study_irreps(pi111,O_h,filepath + "summary_irreps/" + name + ".txt")
