...
p2 = o.PseudoScalarField([-2,-2,-1],modified_momentum_trafo=True)
...
pi221 = r.rep_from_action(O_h,b1,"twopi221")
...
subspaces = r.study_irreps(pi221,O_h,filepath + "summary_irreps/" + name + ".txt")
