...
name = "twopi322"
p1 = o.PseudoScalarField([3,2,2],modified_momentum_trafo=True)
p2 = o.PseudoScalarField([-3,-2,-2],modified_momentum_trafo=True)
...
pi322 = r.rep_from_action(O_h,b1,"twopi322")
...
subspaces = r.study_irreps(pi322,O_h,filepath + "summary_irreps/" + name + ".txt")
